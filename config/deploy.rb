...
set :repo_url, 'https://github.com/suzhen/airline.git'
  ...
  task :restart_thin  do
    on roles(:web),in: :sequence, wait: 3 do
      within release_path do
        execute :bundle,"exec thin restart -C /var/www/airline/shared/config/boot_app.yml"
      end
    end
